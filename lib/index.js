...
const measures = {
  ...
  LineLoad: require("./definitions/lineLoad"),
  BodyForce: require("./definitions/bodyForce"),
  HeatFlux: require("./definitions/heatFlux"),
  FilmCoeff: require("./definitions/filmCoeff"),
  HeatGen: require("./definitions/heatGen"),
  MassFlow: require("./definitions/massFlow"),
  CurrentDensity: require("./definitions/currentDensity"),
  ChargeDensity: require("./definitions/chargeDensity"),
  SurfCharge: require("./definitions/surfCharge"),
};
